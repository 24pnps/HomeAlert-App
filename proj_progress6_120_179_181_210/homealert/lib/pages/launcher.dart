...
class _LauncherState extends State<Launcher> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      NotificationDemo(username: "", email: widget.email), // Placeholder for NotificationDemo
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: GNav(
                  ...
                  rippleColor: const Color(0xFF50A65C),
                  hoverColor: const Color(0xFFF1F3E6),
                  haptic: true,
                  tabBorderRadius: 20,
                  tabActiveBorder: Border.all(color: Colors.black, width: 1),
                  gap: 8,
                  color: const Color(0xFF8D8E87),
                  activeColor: const Color(0xFF232323),
                  iconSize: 24,
                  tabBackgroundColor: const Color(0xFF50A65C),
