                  ...
                  SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: _profilePictureUrl != null
                          ...
                          : const CircularProgressIndicator(), // Placeholder until the image is loaded
                    ),
                  ),
                  Positioned(
...
class ProfileMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var isDark = MediaQuery.of(context).platformBrightness == Brightness.dark;
    var iconColor = isDark ? const Color(0xFFF8FAED) : const Color(0xFF232323);
    ...
    return ListTile(
      leading: Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(100),
            color: const Color(0xFF50A65C).withOpacity(0.1)),
