...
class MainHome extends StatefulWidget {
  ...
  const MainHome({super.key, required this.username, required this.email});
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: current == index
                                  ? Border.all(
                                      color: const Color(0xFF50A65C), width: 2.5)
                                  : null,
                            ),
                            child: Center(
                              child: Column(
...
class RoomImage extends StatelessWidget {
  ...
  const RoomImage(this.imagePath, this.roomName, this.email, {super.key});
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data?.data() == null) {
          return const Text('No devices found'); // No data available
        }
      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            color:
                _powerOn ? Colors.grey[900] : const Color.fromARGB(44, 164, 167, 189),
          ),
          child: Padding(
