...
class NotificationEdit extends StatefulWidget {
  ...
  const NotificationEdit({Key? key, required this.username, required this.itemName})
      : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                padding:
                    const EdgeInsets.only(left: 20.0, top: 3, bottom: 3, right: 20.0),
                child: TextFormField(
